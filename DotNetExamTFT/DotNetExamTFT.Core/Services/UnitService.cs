...
using DotNetExamTFT.Core.Helpers;
using System;
...
namespace DotNetExamTFT.Core.Services
{
    public class UnitService : IUnitService
    {
        ...
        public UnitService()
        {
            ...
            _httpClient = new HttpClient(clientHandler) { BaseAddress = new Uri("https://localhost:44333/api/") };
        }
